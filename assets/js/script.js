...
fetch("https://ipinfo.io/json?token=5607825501f064").then(
    ...
    fetch("https://api.openweathermap.org/data/2.5/onecall?lat=" + latLon[0] + "&lon=" + latLon[1] + "&units=imperial&&exclude=hourly,minutely&appid=c11639f11059953c1817728af454e744").then(
        (response) => response.json()
        ).then( (responseData) => {
            ...
            currentCityWeatherIcon.attr("src", "http://openweathermap.org/img/wn/" + responseData.current.weather[0].icon + "@4x.png")
...
// var splitLoc = userLoc.split(",");

var cityLat = splitLoc[0]
var cityLon = splitLoc[1]
...
var fetchForm = "https://api.openweathermap.org/data/2.5/onecall?lat=" + cityLat + "&lon=" + cityLon + "&units=imperial&appid=c11639f11059953c1817728af454e744"
