...
function genHistory() {
    ...
    searchItem1.text(localStorage.getItem(0))
    searchHistory.append(searchItem2);
    searchItem2.text(localStorage.getItem(1))
    searchHistory.append(searchItem3);
    searchItem3.text(localStorage.getItem(2))
    searchHistory.append(searchItem4);
    searchItem4.text(localStorage.getItem(3))
    searchHistory.append(searchItem5);
    searchItem5.text(localStorage.getItem(4))
}
